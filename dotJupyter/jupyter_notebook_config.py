...
#  Default: ''
c.NotebookApp.browser = u'open -a /Applications/Brave\ Browser.app %s'
...
#  Choices: any of ['blake2b', 'sha1', 'sha3_256', 'md5', 'sha384', 'sha224', 'sha3_512', 'sha512', 'sha256', 'sha3_384', 'sha3_224', 'blake2s']
#  Default: 'sha256'
